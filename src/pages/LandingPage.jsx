...
export default function LandingPage() {
  ...
  async function handleMagicLink(emailId) {
    ...
    if (error) alert('Error: ' + error.message)
    else alert('Ã¢ÂÂ Magic link sent to ' + email + '! Check your inbox.')
  }
  ...
  return (
    <>
      <style>{`
        ...
        .pricing-features li::before{content:'Ã¢ÂÂ';position:absolute;left:0;color:var(--green);font-size:12px}
      ...
      <div className="lp">
        ...
        <nav>
          <a href="/" className="nav-logo"><span className="bolt">Ã¢ÂÂ¡</span> ANKUSHAI</a>
          <ul className="nav-links">
            <li><a href="#features">Features</a></li>
            <li><a href="#pricing">Pricing</a></li>
            <li><a onClick={() => openModal('login')}>Sign In</a></li>
          </ul>
          <a className="nav-cta" onClick={() => openModal('signup')}>Get Access Ã¢ÂÂ</a>
        </nav>
        ...
        <section className="hero">
          ...
          <p className="hero-sub">Real-time signals, AI-powered thesis generation, and portfolio analytics Ã¢ÂÂ everything a serious trader needs, in one platform.</p>
          <div className="hero-actions">
            <button className="btn-primary" onClick={() => openModal('signup')}>Start Free Trial Ã¢ÂÂ</button>
        ...
        <section id="features" className="features-section" style={{position:'relative',zIndex:1,padding:'100px 0'}}>
          <div className="container">
            ...
            <div className="features-grid" style={{marginTop:'48px'}}>
              {[
                {icon:'Ã°ÂÂÂ¡',title:'Live Signal Feed',desc:'Proprietary scoring engine analyzes 50+ technical and macro indicators. Every signal includes confidence score, entry/exit levels, and real-time P&L tracking.'},
                {icon:'Ã°ÂÂ¤Â',title:'AI Thesis Generator',desc:'Describe any trade setup and get a structured investment thesis, risk/reward analysis, and historical analogues Ã¢ÂÂ powered by a fine-tuned financial model.'},
                {icon:'Ã°ÂÂÂ',title:'Portfolio Analytics',desc:'Real-time P&L tracking, drawdown analysis, sector exposure, and Sharpe ratio calculation across your entire portfolio.'},
                {icon:'Ã°ÂÂÂ°',title:'Sentiment Intelligence',desc:'NLP analysis of 10,000+ news sources, earnings transcripts, and Fed communications. Real-time sentiment scores for every major ticker.'},
                {icon:'Ã°ÂÂÂ',title:'Strategy Backtesting',desc:'Backtest any signal combination on 20+ years of tick data. Walk-forward optimization, Monte Carlo simulation, and slippage modeling.'},
                {icon:'Ã¢ÂÂ²',title:'Supabase Real-Time',desc:'Every table syncs live across all browser sessions instantly Ã¢ÂÂ no refresh needed. Built on institutional-grade Postgres infrastructure.'},
              ].map(f => (
          ...
          <div className="container">
            ...
            <div className="pricing-grid">
              <div className="pricing-card">
                ...
                <button className="pricing-btn outline" onClick={()=>openModal('signup')}>Get Started Ã¢ÂÂ</button>
              </div>
              <div className="pricing-card featured">
                ...
                <button className="pricing-btn primary" onClick={()=>openModal('signup')}>Start Free Trial Ã¢ÂÂ</button>
              </div>
              <div className="pricing-card">
                ...
                <button className="pricing-btn outline">Contact Sales Ã¢ÂÂ</button>
              </div>
            </div>
          </div>
        </section>
        ...
        <footer>
          <div className="footer-logo">Ã¢ÂÂ¡ ANKUSHAI</div>
          <div className="footer-links">
            <a href="#">Privacy</a><a href="#">Terms</a><a href="#">Support</a>
          </div>
          <div className="footer-copy">ÃÂ© 2026 AnkushAI. All rights reserved.</div>
        </footer>

        {/* MODAL */}
        <div className="modal-overlay" id="modal" onClick={closeModalOutside}>
          <div className="modal">
            <button className="modal-close" onClick={closeModal}>Ã¢ÂÂ</button>
            <span className="modal-icon">Ã¢ÂÂ¡</span>
            <div id="modal-signup-view">
              ...
              <button className="modal-submit" onClick={()=>handleMagicLink('modal-email')}>Send Magic Link Ã¢ÂÂ</button>
            ...
            <div id="modal-login-view" style={{display:'none'}}>
              ...
              <button className="modal-submit" onClick={()=>handleMagicLink('modal-login-email')}>Send Magic Link Ã¢ÂÂ</button>
              <div className="modal-divider">or</div>
              <button className="modal-google" onClick={handleGoogleAuth}>
                <svg width="18" height="18" viewBox="0 0 18 18"><path fill="#4285F4" d="M16.51 8H8.98v3h4.3c-.18 1-.74 1.48-1.6 2.04v2.01h2.6a7.8 7.8 0 0 0 2.38-5.88c0-.57-.05-.66-.15-1.18z"/><path fill="#34A853" d="M8.98 17c2.16 0 3.97-.72 5.3-1.94l-2.6-2.01c-.72.48-1.63.76-2.7.76-2.07 0-3.83-1.4-4.46-3.27H1.85v2.07A8 8 0 0 0 8.98 17z"/><path fill="#FBBC05" d="M4.52 10.54A4.8 4.8 0 0 1 4.27 9c0-.53.09-1.05.25-1.54V5.39H1.85A8 8 0 0 0 .98 9c0 1.29.31 2.51.87 3.61l2.67-2.07z"/><path fill="#EA4335" d="M8.98 3.58c1.17 0 2.23.4 3.06 1.2l2.3-2.3A8 8 0 0 0 8.98 1a8 8 0 0 0-7.13 4.39l2.67 2.07c.63-1.87 2.4-3.27 4.46-3.27z"/></svg>
                Continue with Google
