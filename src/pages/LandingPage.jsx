    ...
    <>
      ...
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .price-feats li::before{content:'Ã¢ÂÂ';position:absolute;left:0;color:#10b981;font-size:12px;font-weight:700}
      ...
      <nav>
        <a href="/" className="nav-logo">Ã¢ÂÂ¡ ANKUSHAI</a>
        <ul className="nav-links">
          <li><a href="#features">Features</a></li>
          <li><a href="#pricing">Pricing</a></li>
          <li><a onClick={() => setShowModal(true)}>Sign In</a></li>
        </ul>
        <button className="nav-cta" onClick={() => setShowModal(true)}>Get Access Ã¢ÂÂ</button>
      </nav>
      ...
      <div className="hero">
        ...
        <div className="hero-btns">
          <button className="btn-pri" onClick={() => setShowModal(true)}>Start Free Trial Ã¢ÂÂ</button>
      ...
      <section id="features">
        <div className="container">
          ...
          <div className="feat-grid">
            {[
              ['Ã°ÂÂÂ¡','Live Signal Feed','Proprietary scoring engine analyzes 50+ technical and macro indicators. Every signal includes confidence score, entry/exit levels, and real-time P&L tracking.'],
              ['Ã°ÂÂ¤Â','AI Thesis Generator','Describe any trade setup and get a structured investment thesis, risk/reward analysis, and historical analogues Ã¢ÂÂ powered by a fine-tuned financial model.'],
              ['Ã°ÂÂÂ','Portfolio Analytics','Real-time P&L tracking, drawdown analysis, sector exposure, and Sharpe ratio calculation across your entire portfolio.'],
              ['Ã°ÂÂÂ°','Sentiment Intelligence','NLP analysis of 10,000+ news sources and earnings transcripts. Real-time sentiment scores for every major ticker.'],
              ['Ã°ÂÂÂ','Strategy Backtesting','Backtest any signal combination on 20+ years of tick data. Walk-forward optimization and Monte Carlo simulation.'],
              ['Ã¢ÂÂ¡','Real-Time Sync','Every table syncs live across all sessions instantly. Built on institutional-grade Postgres infrastructure.'],
            ].map(([icon,title,desc]) => (
        ...
        <div className="container">
          ...
          <div className="pricing-grid">
            <div className="price-card">
              ...
              <button className="price-btn out" onClick={() => setShowModal(true)}>Get Started Ã¢ÂÂ</button>
            </div>
            <div className="price-card featured">
              ...
              <button className="price-btn pri" onClick={() => setShowModal(true)}>Start Free Trial Ã¢ÂÂ</button>
            </div>
            <div className="price-card">
              ...
              <a href="mailto:ankushtasildar2@gmail.com" className="price-btn out" style={{textDecoration:'none'}}>Contact Sales Ã¢ÂÂ</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer>
        <div className="foot-logo">Ã¢ÂÂ¡ ANKUSHAI</div>
        <div className="foot-links"><a href="#">Privacy</a><a href="#">Terms</a><a href="#">Support</a></div>
        <div className="foot-copy">ÃÂ© 2026 AnkushAI. All rights reserved.</div>
      </footer>

      {modalOpen && (
        <div style={s.overlay} onClick={e => e.target === e.currentTarget && setModalOpen(false)}>
          <div style={s.modal}>
            <button style={s.close} onClick={() => setModalOpen(false)}>Ã¢ÂÂ</button>
            <span style={{fontSize:'32px',display:'block',marginBottom:'16px'}}>Ã¢ÂÂ¡</span>
            ...
            {modalView === 'signup' ? (<>
              ...
              <button style={s.submit} onClick={handleMagicLink} disabled={loading}>{loading ? 'Sending...' : 'Send Magic Link Ã¢ÂÂ'}</button>
              ...
              <div style={s.divider}>or</div>
              <button style={s.google} onClick={handleGoogle} disabled={loading}><GoogleSVG />Continue with Google</button>
              <div style={s.legal}>No account? <a style={s.legalLink} onClick={() => { setModalView('signup'); setMsg('') }}>Get access Ã¢ÂÂ</a></div>
            </>)}
          </div>
        </div>
      )}
